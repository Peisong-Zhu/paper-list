## Papers on Network Representation Learning/Network Embedding.
...
5. **Network Representation Learning with Rich Text Information.**
...
7. **Heterogeneous Network Embedding via Deep Architectures.**
...
11. **Max-Margin DeepWalk: Discriminative Learning of Network Representation.**
...
12. **Structural Deep Network Embedding.**
   *Daixin Wang, Peng Cui, Wenwu Zhu.*  KDD 2016. [paper](http://media.cs.tsinghua.edu.cn/~multimedia/cuipeng/papers/SDNE.pdf)

13. **A General Framework for Content-enhanced Network Representation Learning.** *Xiaofei Sun, Jiang Guo, Xiao Ding, Ting Liu.* arXiv. [paper](https://arxiv.org/pdf/1610.02906.pdf)

14. **Community Preserving Network Embedding.**
...
17. **Fast Network Embedding Enhancement via High Order Proximity Approximation.**
...
18. **TransNet: Translation-Based Network Representation Learning for Social Relation Extraction.**
...
19. **metapath2vec: Scalable Representation Learning for Heterogeneous Networks.**
...
20. **Learning from Labeled and Unlabeled Vertices in Networks.**
...
22. **struc2vec: Learning Node Representations from Structural Identity.**
...
23. **Variation Autoencoder Based Network Representation Learning for Classification.**
